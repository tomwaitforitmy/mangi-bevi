...
export const TAG_REWARDS = [
  ...
  new Reward("Shokugeki Fan", 5, 8),
  new Reward("Foody Blog-Leser", 6, 10),
  new Reward("Schüler von Ottolenghi", 7, 13),
  new Reward("Kocht wie Mutti", 8, 16),
  new Reward("Shokugeki Kämpfer", 9, 19),
  ...
  new Reward("Mehr Tags als Instagram", 22, 200),
  new Reward("TAGsüber nur am TAGgen", 23, 1000),
  new Reward("Tagginator", 24, 10000),
];
