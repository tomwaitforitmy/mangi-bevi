...
describe("GetImagesToUpload: Given list with only appwrite urls", () => {
...
describe("GetImagesToUpload: Given list with one appwrite url", () => {
...
describe("GetImagesAlreadyUploaded: Given list with appwrite", () => {
