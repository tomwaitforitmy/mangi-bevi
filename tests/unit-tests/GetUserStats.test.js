...
describe("GetUserStats", () => {
  it("calculates statistics over two meals", () => {
    ...
    const userId = "u1";
    const expected = new UserStats(userId, 2, 5, 6, true);
  ...
  it("calculates statistics over one meal", () => {
    ...
    const userId = "u1";
    const expected = new UserStats(userId, 2, 3, 3, false);
  ...
  it("returns default values for no meals", () => {
    const userMeals = [];
    const userId = "u1";
    const expected = new UserStats(userId, 0, 0, 0, false);
  ...
  it("calculates values for meals without data", () => {
    ...
    const userId = "u1";
    const expected = new UserStats(userId, 0, 0, 0, true);
